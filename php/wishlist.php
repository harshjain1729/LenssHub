            ...
            <nav style="margin: 0px ;">
                <ul style="margin:auto;">
                    ...
                    if($_SESSION['loggedin']){
                        ...
                        echo '<li class="tabs" id="tab1"><a href="login.php">Login</a></li>';
                    }
                    ?>
                </ul>
            </nav>
        ...
        <div class="container h-100 py-5">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-10">
                    ...
                    // }
                    $mail = $_SESSION['user'];
                    $sql1 = "SELECT * FROM `wishlist` WHERE `customer_id` = '$mail'";
                        ...
                        <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                    <h5 class="mb-0">₹'.$row['specs_price'].'.00</h5>
                                </div>
                                <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                    <a href="removewish.php?sid='.$row['specs_id'].'&cid='.$row['customer_id'].'" class="text-danger"><i class="fas fa-trash fa-lg"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>';
